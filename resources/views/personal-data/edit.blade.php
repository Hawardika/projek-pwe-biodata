...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <form action="{{ route('personal-data.update', $personalData) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="card mb-3 experience-card p-3">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       value="{{ old("experiences.$index.company", $exp->company) }}">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       value="{{ old("experiences.$index.period", $exp->period) }}">
                            </div>
                        ...
                        <div class="card mb-3 education-card p-3">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       value="{{ old("educations.$index.period", $edu->period) }}">
                            </div>
